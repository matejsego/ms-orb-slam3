...
def generate_launch_description():
    ...
    def create_robot_description(context):
        ...
        robot_description_config = xacro.process_file(
            robot_xacro,
            mappings={
                "nicla_camera": context.launch_configurations.get("nicla_camera", "true"),
            	"nicla_tof": context.launch_configurations.get("nicla_tof", "true"),
            	"nicla_tof_visualize": context.launch_configurations.get("nicla_tof_visualize", "true"),
            	"nicla_mic": context.launch_configurations.get("nicla_mic", "true"),
            	"nicla_imu": context.launch_configurations.get("nicla_imu", "true"),
            	"nicla_use_mesh": context.launch_configurations.get("nicla_use_mesh", "false"),
            },
        )
